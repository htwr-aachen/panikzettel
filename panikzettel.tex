...
Es seien $K$-Vektorräume $V$ und $W$ und ein $K$-Vektorraumhomomorphismus $\Phi: V \to W$
...
Um die Determinante deutlich einfacher berechnen zu können, ist es möglich, die Matrix mit unseren elementaren Zeilen- und Spaltenoperationen zu vereinfachen. Dazu gibt es Sätze für jeden Operator:
