...
Determinanten größerer Matrizen werden mit der Laplace-Entwicklung rekursiv berechnet.
Zuerst braucht man da die Definition des Minor:
...
\item Die Ergebnisse der Minoren multipliziert mit dem Wert alternierend addieren. Ob man mit $(-1)$ oder $(+1)$ anfängt, hängt davon ab, ob man in den Minor einer Zeile/Spalte mit geradem Index berechnet: Gerade Zeile $\implies (+1)$
\end{enumerate}
