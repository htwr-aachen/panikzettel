...
Beim \emph{Jacobi-Verfahren} ist $C = D^{-1}$. $O(n)$ Operationen pro Iterationsschritt.
...
Beim \emph{Gauß-Seidel-Verfahren} ist $C = (D-L)^{-1}$. Konvergenz wie beim Jacobi-Verfahren.
\[
