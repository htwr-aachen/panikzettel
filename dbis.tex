...
\begin{itemize}
  ...
  \item \textbf{Generalisierung/Spezialisierung}: (Betrachte untenstehendes ER-Diagramm)
    \begin{itemize}
      ...
      \item Wenn die Spezialisierungen disjunkt ist, verdeutlichen wir das durch: Feldspieler[ID] $\cap$ Torwart[ID] $= \varnothing$.
  \end{itemize}
\end{itemize}
\begin{center}
\scalebox{0.8}{
...
\begin{enumerate}
\item Finde nichttriviale Abhängigkeit $\alpha \to \beta \in F_i^+$ mit $\alpha \cap \beta = \emptyset$ und $\alpha \nrightarrow X_i$.
...
\scalebox{0.64}{
         \begin{tikzpicture}
            %
            \xyshift{40mm}{0}{\btreeinodefour{root}{20}{33}{60}{70}};
            %
