...
\skript{1.53} (Steinitzscher Austauschsatz) In einem Erzeugendensystem $t=(t_1,\ldots,t_n)$ von $V$ darf man Einträge durch beliebige Einträge eines in $V$ linear unabhängigen Tupels $s = (s_1,\ldots,s_k)$ austauschen. % TODO
