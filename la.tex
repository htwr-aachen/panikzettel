...
Für Bonusaufgaben, ist es teilweise notwendig die Ähnlichkeit nicht diagonalisierbarer Matrizen zu zeigen. Wahrscheinlich sind die angegebenen Matrizen dann trigonalisierbar und insb. ähnlich zu ihrer Jordan-Normalform. Die \href{https://de.wikipedia.org/wiki/Jordansche_Normalform}{\textbf{Wikipedia-Seite zur Jordan-Normalform}} ist hier sehr hilfreich. Zuletzt noch ein \href{http://www.math.rwth-aachen.de/~Sebastian.Thomas/teaching/lineare_algebra_ii_09/Beispiel_Jordan-Normalform.pdf}{\textbf{Beispiel von Sebastian Thomas aus LA2 zur Jordan-Normalform}}.
...
\skript{7.CE} Sei $A \in K^{m \times n}$ gegeben. Dann ist $A$ unitär äquivalent zu $\Sigma_{\sigma(A)}$.
