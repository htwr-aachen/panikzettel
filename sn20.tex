...
\begin{figure}[ht!]
	...
	\begin{tikzpicture}
		...
		\node[state,draw=bluishgreen,fill=bluishgreen!20] (s) at (0,0) {Susceptible};
		\node[state,draw=vermillion,fill=vermillion!20] (i) at (6,0) {Infected};
...
\begin{figure}[ht!]
	...
	\node[state,draw=bluishgreen,fill=bluishgreen!20] (s) at (0,0) {Susceptible};
	\node[state,draw=vermillion,fill=vermillion!20] (i) at (5,0) {Infected};
	\node[state,draw=reddishpurple,fill=reddishpurple!20] (r) at (10,0) {Removed};
