...
If there is an imbalanced triangle in a signed network, it can be in indicator that the network will \textbf{tend to change} since it is currently out of equilibrium.
